...
section: Presets
label: Typography
title: '@twind/preset-typography'
excerpt: Beautiful typographic defaults for HTML you don't control.
---
...
```js tailwind.config.js showLineNumbers {5} /require('@tailwindcss/typography')/
module.exports = {
  theme: {
    extend: {
      typography: (theme) => ({
