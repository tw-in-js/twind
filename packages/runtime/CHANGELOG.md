...
- `tw` is a proxy object to the currenrtly active twind instance; this allows HMR ([#245](https://github.com/tw-in-js/twind/pull/245))
...
- simplify auto init to run as soon as the body tag is inserted ([`881e1e16`](https://github.com/tw-in-js/twind/commit/881e1e16005cecd1930cdb988f6983c2b1aff516))
