...
- preflight = 0: The preflight styles and any base styles registered by plugins.
- global = 1: The global styles registered by plugins.
- merged = 2: The merged styles
- components = 4: Component classes and any component classes registered by plugins.
- utilities = 5: Utility classes and any utility classes registered by plugins.
- css = 6: Styles generated by css
