<script>
  ...
  /** @type {string | undefined} */
  export let description = `The smallest, fastest, most feature complete tailwind-in-js solution in existence`
</script>

<svelte:head>
  <title>{[title, 'Twind.style'].filter(Boolean).join(' • ')}</title>
  <meta property="og:title" content={['Twind.style', title].filter(Boolean).join(' • ')} />
  <meta name="twitter:title" content={['Twind.style', title].filter(Boolean).join(' • ')} />
  ...
  <meta property="og:url" content={`https://twind.style${$page.url.pathname}`} />
  <meta property="og:locale" content="en_US" />

  <link rel="manifest" href="/manifest.json?v=1" />
  <meta name="msapplication-config" content="/msapplication-config.xml?v=1" />
  <meta name="apple-mobile-web-app-title" content="Twind.style" />
  <meta name="application-name" content="Twind.style" />
  ...
  <meta
    name="theme-color"
    content={'' + tw.theme('colors.brand.1')}
