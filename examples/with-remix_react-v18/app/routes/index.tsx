...
const linkClass = cx('transition-all duration-300 opacity-75 hover:(opacity-100 text-blue-500)')
  ...
  return (
    <main className="py-16 px-4 max-w-screen-md mx-auto w-full">
      ...
      <ul className="list-disc grid gap-2">
        {links.map((link) => (
          <li key={link.href}>
            <a href={link.href} className={linkClass} target="_blank" rel="noreferrer">
              {link.text}
            </a>
          </li>
        ))}
